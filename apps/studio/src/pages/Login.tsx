    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <img src="/logo.svg" alt="Remotion Studio" className="w-12 h-12 mb-4" />
          <h1 className="text-2xl font-bold text-gray-900 dark:text-zinc-100">Remotion Studio</h1>
          <p className="mt-2 text-sm text-gray-500 dark:text-zinc-400">Create professional videos with code</p>
        </div>
          ...
          {mode === "register" && (
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 placeholder-gray-500 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 transition-colors"
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-2 bg-white dark:bg-zinc-950 text-gray-500 dark:text-zinc-400">
              Or continue with
            </span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <a
            href="/auth/github"
            className="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 hover:bg-gray-50 dark:hover:bg-zinc-800 text-gray-900 dark:text-zinc-100 text-sm font-medium transition-colors"
          >
